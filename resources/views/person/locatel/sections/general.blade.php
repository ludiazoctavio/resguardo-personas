    ...
    <div class="pb-3">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control @error('alias') is-invalid @enderror" id="alias" name="aliases[alias][]" value="{{ old('alias') }}" placeholder="Especifica el apodo o alias con el que responde la persona">
                @error('alias')
                    <div class="invalid-feedback active" role="alert">
                        <strong>{{ $message }}</strong>
                    </div>
    ...
    <div class="border-top py-3">
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="tel" pattern="[0-9]{10}" maxlength="10" minlength="10" class="form-control @error('phone') is-invalid @enderror" id="phone" name="disappearance_report[cell_phone]" value="{{ old('phone') }}">
                @error('phone')
                    <div class="invalid-feedback active" role="alert">
                        <strong>{{ $message }}</strong>
                    </div>
