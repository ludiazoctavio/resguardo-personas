    ...
    <div class="pb-3">
        ...
        <div class="form-row">
            ...
            <div class="form-group required col-md-4">
                ...
                <select class="form-control @error('nationality_id') is-invalid @enderror" id="nationality_id" name="nationality_id" required>
                    <option value="" disabled="" selected="">Selecciona</option>
    ...
    <div class="border-top py-3">
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control @error('confidential') is-invalid @enderror" id="confidential" name="confidential">
                    <option value="" disabled="" selected="">Selecciona</option>
