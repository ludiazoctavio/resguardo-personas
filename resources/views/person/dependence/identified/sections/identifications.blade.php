    ...
    <div class="border-top py-3">
        <div class="form-row">
            ...
            <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control @error('folio') is-invalid @enderror" id="folio" name="identification[folio]" value="{{ old('number_identification') }}" placeholder="Escribe el número o folio ">
                @error('folio')
                    <div class="invalid-feedback active" role="alert">
                        <strong>{{ $message }}</strong>
                    </div>
