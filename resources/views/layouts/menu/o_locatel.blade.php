<li class="mb-2">
  <a class="dropdown-item {!! active_class(route('dashboard.person.create')) !!}" {{--data-toggle="collapse" role="button" aria-expanded="false" aria-controls="multiCollapseExample1"--}} href="{{ route('dashboard.person.create') }}">REGISTRO POR PERSONA NO LOCALIZADA</a>
    {{--<ul id="multiCollapseExample1" class="nav nav-pills collapse multi-collapse" role="tablist">
...
<li>
  <a class="dropdown-item {!! active_class(route('dashboard.search.index')) !!}" href="{{ route('dashboard.search.index') }}">BÚSQUEDA DE REGISTROS</a>
</li>
