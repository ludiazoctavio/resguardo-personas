                ...
                <div class="pb-3">
                    <div class="form-row">
                        <div class="form-group required col-md-4">
                            ...
                            name="name" value="{{ old('name') }}" placeholder="Nombre(s)" required>
                            @error('name')
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            name="last_name_1" value="{{ old('last_name_1') }}" placeholder="Primer apellido" required>
                            @error('last_name_1')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            name="last_name_2" value="{{ old('last_name_2') }}" placeholder="Segundo apellido">
                            @error('last_name_2')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group required col-md-4">
                            ...
                            name="position" value="{{ old('position') }}" placeholder="Cargo" required>
                            @error('position')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            name="phone_extension" value="{{ old('phone_extension') }}" placeholder="Extensión">
                ...
                <div class="border-top py-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            name="password_confirmation" required="required" autocomplete="new-password" placeholder="Confirmar contraseña" required>
