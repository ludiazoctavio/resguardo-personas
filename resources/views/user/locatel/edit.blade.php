                ...
                <div class="pb-3">
                    <div class="form-row">
                        <div class="form-group required col-md-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ $user->name }}" placeholder="Nombre(s)" required>
                            @error('name')
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            <input type="text" class="form-control @error('last_name_1') is-invalid @enderror" id="last_name_1"
                                name="last_name_1" value="{{ $user->last_name_1 }}" placeholder="Primer apellido" required>
                            @error('last_name_1')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('last_name_2') is-invalid @enderror" id="last_name_2"
                                name="last_name_2" value="{{ $user->last_name_2 }}" placeholder="Segundo apellido">
                            @error('last_name_2')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group required col-md-4">
                            ...
                            <input type="text" class="form-control @error('position') is-invalid @enderror" id="position"
                                name="position" value="{{ $user->position }}" placeholder="Cargo" required>
                            @error('position')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            <input type="tel" pattern="[0-9]{10}" maxlength="10" minlength="10" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value="{{ $user->phone }}" placeholder="Teléfono" required>
                            @error('phone')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control @error('phone_extension') is-invalid @enderror" id="phone_extension"
                                name="phone_extension" value="{{ $user->phone_extension }}" placeholder="Extensión">
                    ...
                    <div class="form-row">
                        <div class="form-group required required col-md-4">
                            ...
                            <select class="form-control @error('dependence_id') is-invalid @enderror" id="dependence_id" name="dependence_id" required>
                    ...
                    <div class="form-row">
                        <div class="form-group required col-md-4">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value="{{ $user->email }}" placeholder="Correo electrónico" required>
                            @error('email')
                                <div class="invalid-feedback active" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
